                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=Instrument&sort=$sort>Product</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
									$uid=$row['User'];
                                    echo "<td>" . prav_get("Fullname","registration","uid",$uid) . "</td>";echo "<td>" . prav_get("item_name","item","item_id",$row['item_id']) . "</td>";echo "<td>" . $row['Feedback'] . "</td>";echo "<td>" . $row['Reply'] . "</td>";
                                        echo "<td>";
