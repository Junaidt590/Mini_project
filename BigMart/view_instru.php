        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $orderBy = array('cat_name', 'sub_cat', 'image');
                    $order = 'cat_id';
                    ...
                    if(!empty($_GET['search'])) {
                        $search = ($_GET['search']);
                        $sql = "SELECT * FROM category
                            WHERE CONCAT_WS (cat_name,sub_cat)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=cat_name&sort=$sort>Category name</th>";
										//echo "<th><a href=?search=$search&sort=&order=sub_cat&sort=$sort>Sub category</th>";
										echo "<th><a href=?search=$search&sort=&order=image&sort=$sort>Image</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['cat_name'] . "</td>";//echo "<td>" . $row['sub_cat'] . "</td>";
									echo "<td><img src='".$row['image']."' width='100'></td>";
                                        echo "<td>";
                                            
                                            echo "<a href='category-update.php?cat_id=". $row['cat_id'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='category-delete.php?cat_id=". $row['cat_id'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
