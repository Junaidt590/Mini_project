            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-center">Feedback Details</h2>
                    ...
                    $orderBy = array('User', 'Instrument', 'Feedback', 'Reply');
                    $order = 'Feed_id';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM feedback
                            WHERE CONCAT_WS (User,Instrument,Feedback,Reply)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=Instrument&sort=$sort>Instrument</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
									$uid=$row['User'];
                                    echo "<td>" . prav_get("Fullname","registration","uid",$uid) . "</td>";echo "<td>" . prav_get("instrument_name","instrument","instrument_id",$row['Instrument']) . "</td>";echo "<td>" . $row['Feedback'] . "</td>";echo "<td>" . $row['Reply'] . "</td>";
                                        echo "<td>";
										//Praveen thappily test
                                            ...
                                            echo "<a href='feedback-update.php?Feed_id=". $row['Feed_id'] ."' title='Give Reply' data-toggle='tooltip'><i class='far fa-edit'>Reply</i></a>";
