...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO feedback (User,Instrument,Feedback,Reply) VALUES (?,?,?,?)");
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
						...
						<div class="form-group">
                                <label>Instrument</label>
                                    ...
                                    <?php
                                        $sql = "SELECT *,instrument_id FROM instrument WHERE  instrument_id IN (SELECT instrument_id FROM ordertab WHERE uid=$uid)";
                                        echo $sql;
                                        ...
                                        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                            ...
                                            echo '<option value="' . "$row[instrument_id]" . '"selected="selected">' . "$value" . '</option>';
                                            } else {
                                                echo '<option value="' . "$row[instrument_id]" . '">' . "$value" . '</option>';
                                        }
                                        }
                                    ?>
                                    </select>
