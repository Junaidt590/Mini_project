<?php
      ...
      if(isset($_POST["submit"])){
      	...
      	{
      		$sql="select * from instrument where cat_id='$cat'";	
      	}
...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>view instrumnt user</title>
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src="<?php echo $row['image'] ?>" width="100" height="100" alt="product-img"  />
					...
					<div class="product-content">
						<h4><a href="signin.php"><?php  echo $row['instrument_name'] ?></a></h4>
						<p class="price">Price :<span id="s<?php echo $idd; ?>"><?php echo $row['price'] ?></span> Stock:<h6 id="s<?php echo $idd; ?>"><?php echo $row['stock'] ?></h6></p>
                        <p class="Description"><?php echo $row['description'] ?></p>
						<input type="hidden" id='h<?php echo $idd; ?>' value="<?php echo $row['stock'];?>">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class='row' align='center'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onclick='inc(<?php echo $idd; ?>)'> + </button>&nbsp;&nbsp;<input min="1"  onchange='inc(<?php echo $idd; ?>)' max="" type="number" width="20px" style="width:40px" disabled value="1" id='i<?php echo $idd; ?>'>&nbsp;<button onclick='dec(<?php echo $idd; ?>)'> - </button></div>
                        <a href="?id=<?php echo $idd; ?>&price=<?php echo $price; ?>&stock=<?php echo $stock; ?>">Add To Cart</a>
