						...
						<svg width="135px" height="29px" viewBox="0 0 155 29" version="1.1" xmlns="http://www.w3.org/2000/svg"
							...
							<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" font-size="40"
								...
								<g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
									<!--<text id="MUSIC AMOR">
										<tspan x="108.94" y="325">MUSIC AMOR</tspan>
									</text>-->
								</g>
							</g>
						</svg>
...
<div class="hero-slider">
  <div class="slider-item th-fullpage hero-area" style="background-image: url(images/slider/music.jpg);">
    <div class="container">
      <div class="row">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="category-box">
					<a href="#!">
						<img src="images/shop/category/1.jpg" alt="" />
						<div class="content">
							<h3>Clothes Sales</h3>
				...
				<div class="category-box">
					<a href="#!">
						<img src="images/shop/category/2.jpg" alt="" />
						<div class="content">
							<h3>Smart Casuals</h3>
			...
			<div class="col-md-6">
				<div class="category-box category-box-2">
					<a href="#!">
						<img src="images/shop/category/3.jpg" alt="" />
						<div class="content">
							<h3>Jewellery</h3>
