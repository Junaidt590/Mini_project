...
$dealer = $_POST['dealer'];  
	$query = " UPDATE dealers SET  instrument_id = '$instrument_id',  dealer_name = '$dealer' WHERE d_id = '$d_id'"; 
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="block billing-details">
                  <h4 class="widget-title">edit dealer</h4>
                <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">

<label for="dealer">Dealer Id</label>	
	<input name="d_id" type="text" value="<?php echo $_GET['cat_id'];?>" readonly="readonly" class="form-control" >
...
if ($result->num_rows > 0) {
  // output data of each row
	...
	echo "<select name='instrument_id'>";
  while($row = $result->fetch_assoc()) {
   echo "<option value =".$row['instrument_id'].">".$row['instrument_name']."</option>";
  }
	echo "</select>";
} else {
  echo "0 results";
...
<label for="dealer">Dealer Name</label><input type="text" name="dealer" id="dealer" class="form-control"required />
<br class="clear" /> 	
