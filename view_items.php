...
<?php include 'admin_menu.php' ?>
	  ...
	  ?>
        ...
        <div class="container-fluid">
            <div class="row">
				...
				<tr><th>Product Name</th><th>Category<th>Brand</th><th>Image</th><th>Price</th><th>Stock</th><th>Description</th><th>Action</tr>
	  <?php
  ...
  while($row = $result->fetch_assoc()) {
	  $url="edit_item.php?prod_id=".$row['item_id'];
	    $url2="delete_item.php?prod_id=".$row['item_id'];
   echo "<tr><td>".$row['item_name']."</td>";


$sql3="select* from category where cat_id='".$row['cat_id']."'";
...
$row3 = $result3->fetch_assoc();
  ...
  echo "<td>".$row['brand']."</td>
   ...
   <td><a href='$url'>Update</a></td><td><a href='$url2'>Delete</td></a></tr>";
  }
